...
import { doc, collection, addDoc ,updateDoc, getDoc, setDoc } from "firebase/firestore";
  ...
  return (
    <div>
        ...
        <button onClick={showModal} style={{padding:'5px',justifyContent:'start', background:'none'}} ><img src='/Icons/savings.png' alt="" style={{height:'2rem',paddingRight:'1rem'}} /> Set Saving Gole</button>
              <My_modal title="SET MONTHLY SAVING GOLE." button_name="Set saving gole." isModalOpen={modal} handleCancel={handleCancel}>
